...
const { MONACO_INTEGRATOR_BASE_URL, MONACO_INTEGRATOR_LOADER_URL } = Constants;
export default new MonacoIntegrator({
  MONACO_INTEGRATOR_BASE_URL,
  MONACO_INTEGRATOR_LOADER_URL
});
