...
const NotOptimizedForMobile: React.FC = () => {
  ...
  return (
    <div
      ...
      <div className={`${classes.textContainer} ${commonCss.flexColumn} ${commonCss.center}`}>
        <Typography variant="h1" thickness="semi-bold">
          Oh oh!
        </Typography>
        <Typography>
          Looks like you are using a mobile browser. We are not currently optimized for mobile.
        </Typography>
      </div>
      <Typography
        variant="a"
